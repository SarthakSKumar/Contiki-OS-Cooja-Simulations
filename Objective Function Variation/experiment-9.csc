...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>97.62713415451432</x>
        <y>91.70399618397609</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.285541346487903 0.0 0.0 2.285541346487903 137.40586535120997 76.83042424242443</viewport>
    </plugin_config>
    <width>889</width>
    <z>0</z>
    <height>650</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <notes>PES2UG21CS482
SARTHAK S KUMAR
OBJECTIVE FUNCTION VARIATION</notes>
